...
public class ProductValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if (checkIfEmpty(product.getName())) {
			...
			errors.rejectValue("name", "R-4001", "Product name cannot be empty");
		}
		...
		if (product.getAverageRating() != 0.0) {
			...
			errors.rejectValue("averageRating", "R-4001",
		...
		if (product.getOneStar() != 0 || product.getTwoStar() != 0 || product.getThreeStar() != 0
			...
			errors.rejectValue("fiveStar", "R-4001",
